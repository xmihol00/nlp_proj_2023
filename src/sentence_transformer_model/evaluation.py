...
def evaluate(model_name: str, genres: list[str]):
    # load genres
    ...
    full_dir_name = f"./models/sentence_transformer/{hash_model_name_and_labels(model_name, genres)}/"
    ...
    with open(f"./data/sentence_transformer_model/test_whole_scripts_{model_name}.json", "r") as f:
...
if __name__ == "__main__":
    ...
    total_predicted, average_metrics, _ = evaluate(args.model, args.genres)
